...
issue](https://github.com/cisagov/ansible-role-pypy/issues) in
...
request](https://github.com/cisagov/ansible-role-pypy/pulls), you
...
```console
cd ansible-role-pypy
pyenv virtualenv <python_version_to_use> ansible-role-pypy
pyenv local ansible-role-pypy
